<script setup>
    ...
    import { AddStudentModal } from '../variables.js';
    ...
    const saveStudent = async (e) => {
        if (form.value.studentid === '' || form.value.lname === '' || form.value.fname === '' || form.value.mname === '' || form.value.email === '') {
            ...
            await axios.post('/api/priv/student', formData)
                .then((response) => {
            ...
            <div class="modal-body">
                <form id="frmAddStudent">
                    <div class="form-group">
                        ...
                        <input type="text" name="studentid" autocomplete="off" required v-model="form.studentid" v-bind:disabled="form.submit" />
                    </div>
                    ...
                    <div class="button-group">
                        <button type="button" @click="AddStudentModal = false" v-bind:disabled="form.submit">CANCEL</button>
						<button type="submit" class="submit" @click="saveStudent($event)" v-bind:disabled="form.submit">
